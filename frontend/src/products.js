const products = [
  {
    ...
    description:
      'The Bauer NSX Senior Elbow Pads offer great comfort and mobility with a 2-piece tapered fit, independent bicep, and hydrophobic mesh lining so you can stay dry on the ice. ',
    brand: 'Bauer',
    category: 'elbow',
    price: 89.99,
    countInStock: 3,
  ...
  },
  {
    ...
    description:
      'Whether they’re passing, shooting or handling the puck, the Bauer Vapor X2.9 Junior Hockey Gloves keep young players’ growing hands flexible and free to move with a two-piece thumb. ',
    brand: 'Bauer',
    category: 'gloves',
    price: 100.09,
    countInStock: 3,
  ...
  },
  {
    ...
    description:
      'Break into the game with the Bauer NSX Senior Hockey Skates - a great option for those new to the game and recreational players looking to upgrade. The microfiber liner and anaform ankle pads keep you dry and comfortable throughout the game.',
    brand: 'Bauer',
    category: 'Skates',
    price: 109.99,
    countInStock: 4,
  ...
  },
  {
    ...
    description:
      'The Bauer NSX Senior Hockey Pants are a great option for recreational league players as well as those new to the game. The tapered design was created with stance, fit and stride characteristics in mind for improved mobility no matter what position you play on the ice.',
    brand: 'Bauer',
    category: 'Pants',
    price: 69.99,
    countInStock: 9,
  ...
  },
  {
    ...
    description:
      'CCM Youth Jetspeed 5-Piece Hockey Package',
    brand: 'CCM',
  ...
  },
  {
    ...
    description:
      'Practice with a purpose with the CCM Quicklite 6000 Junior Practice Jersey featuring high performance fabric that keeps you dry, cool and comfortable on the ice. The new knitting construction provides optimal colour fastness post embellishment and enhanced snag resiistance.',
    brand: 'CCM',
    category: 'Jersey',
    price: 15.98,
    countInStock: 20,
  ...
  },
  {
    ...
    description:
      'The 361 Shock Doctor Core Loose Hockey Short is the superior choice for those players who prefer a loose hockey short. We took all of the great features from our previous loose hockey short and updated them to make a more advanced short.',
    brand: 'CCM',
    category: 'Jock Short',
    price: 30.98,
    countInStock: 10,
  ...
  },
  {
    ...
    description:
      'The Bauer Supreme Senior Goalie Neck Guard combines revolutionary G-FORM and XRD materials to absorb energy and protect you from high force impacts so you can stay in the game.',
    brand: 'Bauer',
    category: 'Neck Guard',
    price: 69.29,
    countInStock: 4,
  ...
  },
  {
    ...
    description:
      'Standard ice hockey puck Black',
    brand: 'Bauer',
    category: 'Pucks',
    price: 1.99,
    countInStock: 50,
  ...
  },
  {
    ...
    description:
      'Valued hockey protective kit with stick and skates packs',
    brand: 'No Brand',
    category: 'Socks',
    price: 750.89,
    countInStock: 3,
